    ...
    public class PontoFuncionarioController : ControllerBase
    {
        ...
        public static List<PontoTableFolha> ToPontoTable(List<PontoFuncionario> listaP)
        {
            ...
            foreach (DateTime d in diasPonto)
            {
                ...
                registroLinhaFinalTabela.TotalTrabalhado = (registroLinhaFinalTabela.Saida_1.Subtract(registroLinhaFinalTabela.Entrada_1)) + (registroLinhaFinalTabela.Saida_2.Subtract(registroLinhaFinalTabela.Entrada_2));
