...
public class  PokeConnectionTaks extends AsyncTask<String,Integer,String> {
    private ArrayList<Pokemon> pokemons = new ArrayList<Pokemon>();
    private onRequestListener listener;

    public PokeConnectionTaks(onRequestListener listener){ this.listener = listener; }
